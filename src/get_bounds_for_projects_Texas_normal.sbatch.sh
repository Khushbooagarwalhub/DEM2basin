...
##-----------------------------------------------------------------------------
##
#SBATCH -J dem2basin_bounds_Texas_normal.%j    # Job name
#SBATCH -o dem2basin_bounds_Texas_normal.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e dem2basin_bounds_Texas_normal.e%j    # Name of stderr error file (%j expands to jobId)
...
python3 $DEM2BASIN_KAG/src/get_bounds_for_projects_Texas_normal.py
