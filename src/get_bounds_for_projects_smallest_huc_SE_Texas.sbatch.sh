...
##-----------------------------------------------------------------------------
##
#SBATCH -J dem2basin_bounds_smallest_development.%j    # Job name
#SBATCH -o dem2basin_bounds_smallest_development.o%j    # Name of stdout output file (%j expands to jobId)
#SBATCH -e dem2basin_bounds_smallest_development.e%j    # Name of stderr error file (%j expands to jobId)
...
python3 $DEM2BASIN_KAG/src/get_bounds_for_projects_smallest_huc_SE_Texas_development.py
