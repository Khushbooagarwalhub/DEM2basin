...
def pycallgraph_smallest_tx_hu12():
    with PyCallGraph(output=GraphvizOutput()):
        prepare_and_output_geoflood_gis_inputs_by_huc(
            '/scratch/04950/dhl/WBD-TX-Smallest_HU12.geojson',
            '/scratch/projects/tnris/dhl-flood-modelling/WBD-HU12-TX.shp',
            '/scratch/projects/tnris/dhl-flood-modelling/NFIEGeo_TX.gdb',
            '/scratch/projects/tnris/dhl-flood-modelling/TNRIS-LIDAR-Availability-20210812.shp',
            '/scratch/projects/tnris/tnris-lidardata',
            '/scratch/04950/dhl/WBD-TX-Smallest_HU12-DEM2basin_output',
